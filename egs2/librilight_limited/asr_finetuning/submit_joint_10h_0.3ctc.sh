...
source path.sh
echo "joint 1-h 0.3 ctc finetuning"
...
--train_set "train_10h" \
--asr_config conf/tuning/train_joint_char_0.3ctc_10h.yaml \
--asr_tag lr0.00002_3.2Mbb_1ag_char_jointscratch_epoch101_10h_0.3ctc \
--stage 11 \
--stop_stage 11
