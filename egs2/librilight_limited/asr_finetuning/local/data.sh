...
train_set="train_10h"
train_set_1hr="train_1h"
train_set_10min="train_10m_0"
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    log "stage 3a: combine 10hr training sets"
    ./utils/combine_data.sh \
	data/${train_set} data/train_1h_{0..5}_{clean,other} data/train_9h_{clean,other}
    log "stage 3b: combine 1hr training sets"
    ./utils/combine_data.sh \
	data/${train_set_1hr} data/train_1h_{0..5}_{clean,other}
    log "stage 3c: combine 10min training sets"
    ./utils/combine_data.sh \
	data/${train_set_10min} data/train_1h_0_{clean,other}
fi
