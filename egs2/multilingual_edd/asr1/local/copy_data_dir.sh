...
if [ -f $srcdir/text_cls ]; then
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text_cls >$destdir/text_cls
fi
...
for f in feats.scp cmvn.scp vad.scp utt2lang utt2uniq utt2dur utt2num_frames text text_cls wav.scp reco2file_and_channel frame_shift stm glm ctm; do
