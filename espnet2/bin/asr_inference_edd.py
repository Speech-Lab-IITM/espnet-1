...
from espnet2.tasks.multilingual_asr_edd import MultilingualASRTask
...
class Speech2Text:
    ...
    def __init__(
        ...
        if asr_model.use_transducer_decoder:
            ...
            beam_search = None
            beam_search_for_decoder_out = None
        else:
            ...
            logging.info(f"Beam_search for decoder out: {beam_search_for_decoder_out}")
        ...
        self.beam_search_for_decoder_out = beam_search_for_decoder_out
...
def inference(
    ...
    loader = MultilingualASRTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=MultilingualASRTask.build_preprocess_fn(speech2text.asr_train_args, False),
        collate_fn=MultilingualASRTask.build_collate_fn(speech2text.asr_train_args, False),
