...
from espnet2.ssl_asr.espnet_model import ESPnetSSLASRModel
...
class SSL_ASRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            "--model_conf",
            action=NestedDictAction,
            default=get_default_kwargs(ESPnetSSLASRModel),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ESPnetSSLASRModel:
        assert check_argument_types()        
